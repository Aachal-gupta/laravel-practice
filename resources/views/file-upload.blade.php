...
<body>
    <div class="container">
        ...
        <form action="{{route('user.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-12">
                    <input type="file" name="photo" accept=".jpg,.png,.jpeg">  <!-- in accept attribute we cazn pass audio/ or video/  -->
                    @error('photo')
        ...
        <div class="row">
            @foreach ($users as $user)
                <div class="col-2">
                    <img  class="img-fluid img-thumbnail"  src="{{asset('/storage/'. $user->file_name)}}" alt="">  <!--  php artisan storage:link-->
